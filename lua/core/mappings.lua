...
M.windows = function ()
  ...
  map("n", m.close_current, "<C-w>")
  map("n", m.move_down, "<C-w><C-j>")
  map("n", m.move_up, "<C-w><C-k>")
  map("n", m.move_left, "<C-w><C-l>")
  map("n", m.move_right, "<C-w><C-h>")
  map("n", m.move_to_down, "<C-w><S-j>")
  map("n", m.move_to_up, "<C-w><S-k")
  map("n", m.move_to_left, "<C-w><S-l>")
  map("n", m.move_to_right, "<C-w><S-h>")
